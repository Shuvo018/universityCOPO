    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            while ($rcRow = mysqli_fetch_assoc($rcResult)) {
                ...
                if (getStuAssignMark($bctId, $stu_id) == null) {
                    newStu($bctId, $stu_id);
                }
                $stuMark = getStuAssignMark($bctId, $stu_id);
                ...
                echo "<tr>
                    ...
                    <td>{$stuMark['total']}</td>
                    <td>{$stuMark['term']}</td>
                    <td><a href = './editStuMark/editAssignment.php?stuRowId={$stuMark['id']}' class='btn btn-primary'> edit </a></td>
                    </tr>";
            }
...
function getStuAssignMark($bctId, $stu_id)
{
    require "../db.php";
    $term = $_SESSION['ass_term'];
    $attanSql = "SELECT `id`, `co1`, `co2`, `co3`, `co4`, `co5`, `total`, `term`, `bct_id`, `stu_id` FROM `assignment` 
...
function newStu($bctId, $stu_id)
{
    ...
    $term = $_SESSION['ass_term'];
    $setSql = "INSERT INTO `assignment`(`co1`, `co2`, `co3`, `co4`, `co5`, `total`, `term`, `bct_id`, `stu_id`) VALUES 
