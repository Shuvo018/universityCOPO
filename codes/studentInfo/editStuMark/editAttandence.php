...
if (isset($_GET['stuAttMarkId'])) {
    $_SESSION['stuAttMarkId'] = $_GET['stuAttMarkId'];
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    <h1>Edit student attandence</h1>
    <?php
    include("../header.php");

    $stuMarkId = $_SESSION['stuAttMarkId'];
...
function updateStuValue($id)
{
    ...
    $arr = getFormValue();
    $updateSql = "UPDATE `attandence` SET `co1`='$arr[0]',`co2`='$arr[1]',`co3`='$arr[2]',`co4`='$arr[3]',
...
function getStuAttanMark($stuMarkId)
{
